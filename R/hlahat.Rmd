...
plot_ly() %>%
  add_trace(data=dna, x=~Gene, y=~2^ld, type='box', notched=TRUE, name='DNA', boxpoints='all', jitter=0.3, pointpos=0, 
    color = list(color = 'rgb(49,130,189)'), 
    marker = list(color = 'rgb(49,130,189)')) %>%
  add_trace(data=rna, x=~Gene, y=~2^ld, type='box', notched=TRUE, name='RNA', boxpoints='all', jitter=0.3, pointpos=0,
